!function (a, b, c, d) {
    ...
    Foundation.libs.abide = {
        name: "abide", version: "5.2.2", settings: {
            ...
            var d = this.parse_patterns(a), e = d.length, f = this.S(a[0]).closest("[data-" + this.attr_name(!0) + "]"),
            ...
            for (var c = b.length, d = [], e = this.S(b[0][0]).closest("[data-" + this.attr_name(!0) + "]"), f = e.data(this.attr_name(!0) + "-init") || {}; c--;) {
                var g, h, i = b[c][0], j = b[c][2], k = i.value, l = this.S(i).parent(),
                    m = i.getAttribute(this.add_namespace("data-abide-validator")), n = "radio" === i.type,
                    o = "checkbox" === i.type, p = this.S('label[for="' + i.getAttribute("id") + '"]'),
    ...
    Foundation.libs.accordion = {
        ...
        events: function () {
            ...
            c(this.scope).off(".fndtn.accordion").on("click.fndtn.accordion", "[" + this.attr_name() + "] dd > a", function (d) {
                var e = c(this).closest("[" + b.attr_name() + "]"), f = c("#" + this.href.split("#")[1]),
                    g = c("dd > .content", e), h = a("dd", e), i = e.data(b.attr_name(!0) + "-init"),
                    j = c("dd > .content." + i.active_class, e), k = c("dd." + i.active_class, e);
    ...
    Foundation.libs.dropdown = {
        ...
        adjust_pip: function (a, b) {
            ...
            var d = ".f-dropdown.open:before", e = ".f-dropdown.open:after", f = "left: " + a + "px;",
                g = "left: " + (a - 1) + "px;";
    ...
    Foundation.libs.equalizer = {
        name: "equalizer",
        version: "5.2.2",
        settings: {use_tallest: !0, before_height_change: a.noop, after_height_change: a.noop},
        init: function (a, b, c) {
        ...
        equalize: function (b) {
            var c = !1, d = b.find("[" + this.attr_name() + "-watch]:visible"), e = d.first().offset().top,
    ...
    Foundation.libs.joyride = {
        name: "joyride", version: "5.2.2", defaults: {
            ...
            var c = b.$li.attr(this.add_namespace("data-button")) || b.$li.attr(this.add_namespace("data-text")),
                d = b.$li.attr("class"),
                e = a(this.tip_template({tip_class: d, index: b.index, button_text: c, li: b.$li}));
            ...
            var e = (Math.ceil(a(b).height() / 2), this.settings.$next_tip.offset(), this.settings.$next_tip.find(".joyride-nub")),
                f = Math.ceil(e.outerWidth() / 2), g = Math.ceil(e.outerHeight() / 2), h = c || !1;
    ...
    Foundation.libs["magellan-expedition"] = {
        ...
        update_arrivals: function () {
            ...
            a("[" + this.attr_name() + "]", c.scope).each(function () {
                var b = a(this), e = e = b.data(c.attr_name(!0) + "-init"), f = c.offsets(b, d),
    ...
    Foundation.libs.offcanvas = {
        name: "offcanvas", version: "5.2.2", settings: {}, init: function () {
            this.events()
        }, events: function () {
            var a = this, b = a.S;
    ...
    var d = function () {
        ...
        var d, e, f = this, g = b.timer_speed, h = a.find("." + b.timer_progress_class),
            i = h && "none" != h.css("display"), j = -1;
    ...
    Foundation.libs.reveal = {
        ...
        close: function (a) {
            var a = a && a.length ? a : this.S(this.scope), b = this.S("[" + this.attr_name() + "].open"),
    ...
    Foundation.libs.slider = {
        ...
        calculate_position: function (b, c) {
            var d = this, e = a.extend({}, d.settings, d.data_options(b.parent())),
        ...
        set_ui: function (b, c) {
            var d = a.extend({}, this.settings, this.data_options(b.parent())), e = a.data(b[0], "handle_w"),
                f = a.data(b[0], "bar_w"), g = this.normalized_percentage(c, d.start, d.end), h = g * (f - e) - 1,
                i = 100 * g;
    ...
    Foundation.libs.tab = {
        name: "tab", version: "5.2.2", settings: {
            ...
            var f = this.S, g = c.closest("[" + this.attr_name() + "]"), h = c.children("a").first(),
                i = "#" + h.attr("href").split("#")[1], j = f(i), k = c.siblings(),
    ...
    Foundation.libs.topbar = {
        ...
        events: function () {
            ...
            d(this.scope).off(".topbar").on("click.fndtn.topbar", "[" + this.attr_name() + "] .toggle-topbar", function (a) {
                ...
                if (c.breakpoint()) {
                    a.preventDefault();
                    var b = d(this), e = b.closest("[" + c.attr_name() + "]"), f = e.find("section, .section"),
